...
<script>
  ...
  import {setKeepAliveExcludeMenus} from "../../util/menu";
    ...
    methods: {
      ...
      menuTag(value, action) {
        if (action === "remove") {
          ...
          if (website.keepAlive) {
            setKeepAliveExcludeMenus(this.$store.state.user.keepAliveExcludeMenus, [tag.value], false);
          }
      ...
      closeAllTags() {
        ...
        this.tagList.forEach(item => {
          appmenu.push(item.value);
        })
        setKeepAliveExcludeMenus(this.$store.state.user.keepAliveExcludeMenus, appmenu, false);
        this.contextmenuFlag = false;
